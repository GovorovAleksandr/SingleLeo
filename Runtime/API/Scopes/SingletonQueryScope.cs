namespace GovorovAleksandr.SingleLeo
{
    public readonly ref struct SingletonQueryScope<T> where T : struct
    {
        ...
        internal SingletonQueryScope(EcsSingleton singleton, bool isValid = true)
        {
        ...
        {
            return new(_singleton, _isValid && _singleton.Has<TComponent>());
        }
        ...
        public bool TryGet(out EcsSingleton singleton)
        {
